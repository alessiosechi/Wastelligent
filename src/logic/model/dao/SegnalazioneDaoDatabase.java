...
public class SegnalazioneDaoDatabase implements SegnalazioneDao {
	...
	public List<Segnalazione> getSegnalazioniAssegnate(int idOperatore) {
		...
		try {
			...
			logger.severe("Errore durante il recupero delle segnalazioni assegnate all'operatore " + idOperatore + ": "
					+ e.getMessage());
		}
	...
	public List<Segnalazione> getSegnalazioniRiscontrateByUtente(int idUtente) {
		...
		try {
			...
			logger.severe("Errore durante il recupero delle segnalazioni riscontrate per l'utente " + idUtente + ": "
					+ e.getMessage());
		}
